...
public class DisplayDelightBlocks {
    ...
    public static Block createFieryFoodBlock(String name, Identifier foodItemId) {
        return register(
                name,
    ...
    public static Block createFieryWideFoodBlock(String name, Identifier foodItemId) {
        return register(
                name,
    ...
    public static Block createFierySmallPlatedBlock(String name, Identifier foodItemId) {
        return register(
                name,
    ...
    public static Block createFieryStackablePlatedBlock(String name, Identifier foodItemId, int maxStacks) {
        return register(
                name,
