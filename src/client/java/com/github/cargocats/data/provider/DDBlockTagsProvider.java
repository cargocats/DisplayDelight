...
public class DDBlockTagsProvider extends FabricTagProvider.BlockTagProvider {
    public DDBlockTagsProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
